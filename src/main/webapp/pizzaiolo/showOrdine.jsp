			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9">${show_ordine_attr.utente.id}</dd>
					    	</dl>
					    ...
					    <div class='card-footer'>
						        <a href="${pageContext.request.contextPath}/pizzaiolo/ExecuteListOrdineServlet" class='btn btn-outline-secondary' style='width:80px'>
